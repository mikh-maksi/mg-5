...
<body>
    ...
    <div class="deactive"><button id = 'sndUpd' style = "">Send</button></div>
    <div id="output"></div>
    ...
    function reqReadyStateChange() {/*console.log(request.readyState);*/
        if (request.readyState == 4) {    
            ...
            if (status == 200) { 
                ...
                d.className ="alert alert-success usrUpd";
                output.appendChild(d);  
                

/*                var inpt1 = document.createElement("input");
                inpt1.value = obj.contact;
                d.appendChild(inpt1);
*/
               // sndUpd.remove();
                ...
                d.insertAdjacentHTML('beforeend', "<span>Коментар:</span><input id = 'comments' value = "+obj.comments+"><br>" );
//                d.insertAdjacentHTML('beforeend', "<button id = 'sndUpd'>Зберегти зміни</button>" );
              //  d.insertAdjacentElement('beforeend', "<button id = 'sndUpd'>Зберегти зміни</button>" );
              comments.after(sndUpd);
